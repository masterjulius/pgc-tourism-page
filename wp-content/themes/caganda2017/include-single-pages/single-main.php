...
<?php
  ...
  $author_top_meta_name = rwmb_meta('cag_announcements_register_meta_box_author_id', 'text', $post_id);
...
<div class="cag-share">
  <div class="fixed-action-btn click-to-toggle">
    ...
    <ul>
      ...
      <li><a  href="//www.plus.google.com" class="btn-floating waves-effect waves-light" id="cag-news-post-share-btn-twitr"><i class="cagicon-google-plus"></i></a></li>
    </ul>
  </div>
</div><!-- END FAB SHARE -->