<?php 
/*
 * Template Name: Cagayan Bids and Awards Page
 */
get_header();
?>
<link rel="stylesheet" type="text/css" href="<?php echo get_stylesheet_directory_uri(); ?>/css/page-bids-and-awards.min.css" />
