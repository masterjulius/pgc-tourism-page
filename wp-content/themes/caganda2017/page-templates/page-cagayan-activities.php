<?php 
/*
 * Template Name: Cagayan Activities Page
 * The Activities page template file
 */
get_header();
...
<?php	
	...
	$rdio_finished_meta_id = "cag_activities_post_meta_box_event_type_id";
	$top_story_ret = get_posts(
		array(
			...
			'meta_query' => array(
				array(
      				'key' => $rdio_finished_meta_id, // this key will change!
      				'compare' => '=',
      				'value' => 'actvty'
      			)
			),
